...
/// <summary>
/// Defines a synchronous handler for a http request.
/// </summary>
/// <typeparam name="TRequest">The type of request being handled</typeparam>
public abstract class HttpRequestHandler<TRequest> : RequestHandler<TRequest, IHttpResponse>
...
public abstract class HttpRequestHandler<TRequest, TResponse> : RequestHandler<TRequest, IHttpResponse<TResponse>>
